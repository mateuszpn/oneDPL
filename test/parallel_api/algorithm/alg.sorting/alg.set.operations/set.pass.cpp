...
struct comp_select_first{
    ...
    bool operator()(_T1 t1, _T2 t2) const
    {
...
struct test_set_intersection
{
               ...
               Compare comp)
    {
                      ...
                      TestUtils::is_base_of_iterator_category<::std::random_access_iterator_tag, InputIterator2>::value)
        {
            ...
            auto zip_last1 = oneapi::dpl::make_zip_iterator(last1, oneapi::dpl::counting_iterator<int>(std::distance(first1, last1)));
            ...
            auto zip_expect_res = ::std::set_intersection(zip_first1, zip_last1, zip_first2, zip_last2, zip_expect, comp_select_first(comp));
            auto zip_res = ::std::set_intersection(exec, zip_first1, zip_last1, zip_first2, zip_last2, zip_out, comp_select_first(comp));
