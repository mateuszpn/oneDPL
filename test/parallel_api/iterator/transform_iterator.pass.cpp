...
test_copyable()
{
    ...
    EXPECT_TRUE(::std::is_trivially_copyable_v<oneapi::dpl::counting_iterator<int>>,
    ...
    EXPECT_TRUE(::std::is_trivially_copyable_v<decltype(trans_count)>,
    ...
    EXPECT_TRUE(::std::is_trivially_copyable_v<decltype(trans_array)>,
