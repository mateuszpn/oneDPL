                                 ...
                                 _BinaryOperation1 __binary_op1, _BinaryOperation2 __binary_op2)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__parallel_transform_reduce_async<_RepackedTp, _BinaryOperation1,
                                                                                _Functor>(
                                 ...
                                 _Tp __init, _BinaryOperation __binary_op, _UnaryOperation __unary_op)
{
    ...
    return oneapi::dpl::__par_backend_hetero::__parallel_transform_reduce_async<_RepackedTp, _BinaryOperation,
                                                                                _Functor>(
