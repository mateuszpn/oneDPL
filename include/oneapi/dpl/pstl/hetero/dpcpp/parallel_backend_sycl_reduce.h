...
void
__work_group_reduce_kernel(const _NDItemId __item_id, const _Size __iters_per_work_item, const _Size __n,
                           const _Size __n_items, _TransformPattern __transform_pattern,
                           ...
                           const _Res& __res_acc, const _Acc&... __acc)
{
    ...
    __transform_pattern(__item_id, __iters_per_work_item, __n, /*global_offset*/ (_Size)0, __local_mem, __acc...);
...
void
__device_reduce_kernel(const _NDItemId __item_id, const _Size __iters_per_work_item, const _Size __n,
                       const _Size __n_items, _TransformPattern __transform_pattern, _ReducePattern __reduce_pattern,
...
struct __parallel_transform_reduce_small_submitter<_Tp, __work_group_size, __internal::__optional_kernel_name<_Name...>>
{
    template <typename _ExecutionPolicy, typename _Size, typename _ReduceOp, typename _TransformOp, typename _InitType,
              ...
              typename... _Ranges>
    auto
    operator()(_ExecutionPolicy&& __exec, const _Size __iters_per_work_item, const _Size __n, _ReduceOp __reduce_op,
               _TransformOp __transform_op, _InitType __init, _Ranges&&... __rngs) const
    {
        ...
        sycl::event __reduce_event =
            __exec.queue().submit([&, __iters_per_work_item, __n, __n_items](sycl::handler& __cgh) {
                ...
                __cgh.parallel_for<_Name...>(
                    ...
                    [=](sycl::nd_item<1> __item_id) {
                        ...
                        __work_group_reduce_kernel<_Tp>(__item_id, __iters_per_work_item, __n, __n_items,
                                       ...
                                       _TransformOp __transform_op, _InitType __init, _Ranges&&... __rngs)
{
    ...
    {
        _Size __iters_tmp = oneapi::dpl::__internal::__dpl_ceiling_div(__iters_per_work_item, 4);
        __iters_per_work_item = __iters_tmp * 4;
    }
...
template <typename _Tp, ::std::uint16_t __work_group_size, typename... _KernelName>
struct __parallel_transform_reduce_device_kernel_submitter<_Tp, __work_group_size,
                                                           __internal::__optional_kernel_name<_KernelName...>>
{
    template <typename _ExecutionPolicy, typename _Size, typename _ReduceOp, typename _TransformOp, typename _InitType,
              ...
              typename... _Ranges>
    auto
    operator()(_ExecutionPolicy&& __exec, const _Size __iters_per_work_item, _Size __n, _ReduceOp __reduce_op,
               _TransformOp __transform_op, _InitType __init, sycl::buffer<_Tp>& __temp, _Ranges&&... __rngs) const
    {
        auto __transform_pattern =
            unseq_backend::transform_reduce<_ExecutionPolicy, _ReduceOp, _TransformOp>{__reduce_op, __transform_op};
        auto __reduce_pattern = unseq_backend::reduce_over_group<_ExecutionPolicy, _ReduceOp, _Tp>{__reduce_op};
        ...
        return __exec.queue().submit([&, __iters_per_work_item, __n, __n_items](sycl::handler& __cgh) {
            oneapi::dpl::__ranges::__require_access(__cgh, __rngs...); // get an access to data under SYCL buffer
            ...
            __cgh.parallel_for<_KernelName...>(
                ...
                [=](sycl::nd_item<1> __item_id) {
                    __device_reduce_kernel<_Tp>(__item_id, __iters_per_work_item, __n, __n_items, __transform_pattern,
                                                __reduce_pattern, __temp_local, __temp_acc, __rngs...);
                });
        });
    }
}; // struct __parallel_transform_reduce_device_kernel_submitter
...
template <typename _Tp, ::std::uint16_t __work_group_size, typename... _KernelName>
struct __parallel_transform_reduce_work_group_kernel_submitter<_Tp, __work_group_size,
                                                               __internal::__optional_kernel_name<_KernelName...>>
{
    template <typename _ExecutionPolicy, typename _Size, typename _ReduceOp, typename _TransformOp, typename _InitType,
              oneapi::dpl::__internal::__enable_if_device_execution_policy<_ExecutionPolicy, int> = 0>
    auto
    operator()(_ExecutionPolicy&& __exec, const _Size __iters_per_work_item, sycl::event& __reduce_event, _Size __n,
               _ReduceOp __reduce_op, _TransformOp __transform_op, _InitType __init, sycl::buffer<_Tp>& __temp) const
    {
        ...
        __reduce_event = __exec.queue().submit([&, __iters_per_work_item, __n, __n_items](sycl::handler& __cgh) {
                                     ...
                                     _TransformOp __transform_op, _InitType __init, _Ranges&&... __rngs)
{
    ...
    {
        _Size __iters_tmp = oneapi::dpl::__internal::__dpl_ceiling_div(__iters_per_work_item_device_kernel, 4);
        __iters_per_work_item_device_kernel = __iters_tmp * 4;
    }
    ...
    sycl::event __reduce_event =
        __parallel_transform_reduce_device_kernel_submitter<_Tp, __work_group_size, _ReduceDeviceKernel>()(
            __exec, __iters_per_work_item_device_kernel, __n, __reduce_op, __transform_op, __init, __temp,
            ::std::forward<_Ranges>(__rngs)...);

    __n = __n_groups; // Number of preliminary results from the device kernel.
    return __parallel_transform_reduce_work_group_kernel_submitter<_Tp, __work_group_size, _ReduceWorkGroupKernel>()(
        ::std::forward<_ExecutionPolicy>(__exec), __iters_per_work_item_work_group_kernel, __reduce_event, __n,
...
struct __parallel_transform_reduce_impl
{
           ...
           _TransformOp __transform_op, _InitType __init, _Ranges&&... __rngs)
    {
        ...
        //if (__queue.get_device().is_gpu())
        //    __iters_per_work_item = 32;  // Empirically tested
        //else
        //{
        //    // distribution is ~1 work groups per compute unit
        //    auto __max_compute_units = oneapi::dpl::__internal::__max_compute_units(__exec);
        //    __iters_per_work_item = oneapi::dpl::__internal::__dpl_ceiling_div(__n, (__max_compute_units * __work_group_size));
        //}
        ...
        do
        {
            __reduce_event = __exec.queue().submit([&, __is_first, __offset_1, __offset_2, __n, __n_items,
                                                    __iters_per_work_item, __n_groups](sycl::handler& __cgh) {
                __cgh.depends_on(__reduce_event);
                ...
                __cgh.parallel_for<_ReduceKernel>(
                    ...
                    [=](sycl::nd_item<1> __item_id) {
                        ...
                        // 1. Initialization (transform part). Fill local memory
                        if (__is_first)
                            __transform_pattern1(__item_id, __iters_per_work_item, __n, /*global_offset*/ (_Size)0,
                                                 __temp_local, __rngs...);
                        else
                            __transform_pattern2(__item_id, __iters_per_work_item, __n, __offset_2, __temp_local,
                                                 __temp_acc);
                        __dpl_sycl::__group_barrier(__item_id);
                        // 2. Reduce within work group using local memory
                            ...
                            _InitType __init, _Ranges&&... __rngs)
{
    ...
    if (__work_group_size >= 256)
    {
        ...
        {
            return __parallel_transform_reduce_mid_impl<_Tp, 256>(::std::forward<_ExecutionPolicy>(__exec), __n,
                                                                  __reduce_op, __transform_op, __init,
                                                                  ::std::forward<_Ranges>(__rngs)...);
        }
    }
    // Otherwise use a recursive tree reduction.
    return __parallel_transform_reduce_impl<_Tp>::submit(::std::forward<_ExecutionPolicy>(__exec), __n,
