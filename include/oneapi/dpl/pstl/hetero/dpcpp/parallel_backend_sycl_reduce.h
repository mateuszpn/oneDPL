...
constexpr sycl::specialization_id<::std::uint8_t> __iters_per_work_item_sc;
...
void
__work_group_reduce_kernel(const _NDItemId __item_id, const _Size __n, const ::std::uint8_t __iters_per_work_item,
...
void
__device_reduce_kernel(const _NDItemId __item_id, const _Size __n, const ::std::uint8_t __iters_per_work_item,
...
struct __parallel_transform_reduce_small_submitter<_Tp, __work_group_size, __internal::__optional_kernel_name<_Name...>>
{
               ...
               _InitType __init, _Ranges&&... __rngs) const
    {
        ...
        const ::std::uint8_t __iters_per_work_item = __set_iters_per_work_item(__n, __work_group_size);
        ...
        sycl::event __reduce_event = __exec.queue().submit([&, __n, __n_items](sycl::handler& __cgh) {
            ...
            __cgh.set_specialization_constant<__iters_per_work_item_sc>(__iters_per_work_item);
            __cgh.parallel_for<_Name...>(
                sycl::nd_range<1>(sycl::range<1>(__work_group_size), sycl::range<1>(__work_group_size)),
                [=](sycl::nd_item<1> __item_id, sycl::kernel_handler __kh) {
                    auto __res_ptr = __res_acc.__get_pointer();
                    auto __iters_per_work_item = __kh.get_specialization_constant<__iters_per_work_item_sc>();
                    __work_group_reduce_kernel<_Tp>(__item_id, __n, __iters_per_work_item, __n_items,
                                                           ...
                                                           __internal::__optional_kernel_name<_KernelName...>>
{
    template <typename _ExecutionPolicy, typename _Size, typename _ReduceOp, typename _TransformOp, typename _InitType,
              ...
              typename... _Ranges>
    auto
    operator()(_ExecutionPolicy&& __exec, _Size __n, const ::std::uint8_t __iters_per_work_item, _ReduceOp __reduce_op,
               _TransformOp __transform_op, _InitType __init, sycl::buffer<_Tp>& __temp, _Ranges&&... __rngs) const
    {
        ...
        return __exec.queue().submit([&, __n, __n_items](sycl::handler& __cgh) {
            ...
            __cgh.parallel_for<_KernelName...>(
                ...
                [=](sycl::nd_item<1> __item_id, sycl::kernel_handler __kh) {
                    auto __iters_per_work_item = __kh.get_specialization_constant<__iters_per_work_item_sc>();
                    __device_reduce_kernel<_Tp>(__item_id, __n, __iters_per_work_item, __n_items, __transform_pattern,
                                                               ...
                                                               __internal::__optional_kernel_name<_KernelName...>>
{
    template <typename _ExecutionPolicy, typename _Size, typename _ReduceOp, typename _TransformOp, typename _InitType,
              oneapi::dpl::__internal::__enable_if_device_execution_policy<_ExecutionPolicy, int> = 0>
    auto
    operator()(_ExecutionPolicy&& __exec, sycl::event& __reduce_event, _Size __n,
               const ::std::uint8_t __iters_per_work_item, _ReduceOp __reduce_op, _TransformOp __transform_op,
               _InitType __init, sycl::buffer<_Tp>& __temp) const
    {
        ...
        if (__iters_per_work_item == 1 && __n < __work_group_size)
        {
                                     ...
                                     _TransformOp __transform_op, _InitType __init, _Ranges&&... __rngs)
{
    ...
    // number of buffer elements processed within workgroup
    const ::std::uint8_t __iters_per_work_item_device_kernel = __set_iters_per_work_item(__n, __work_group_size);
    ...
    sycl::event __reduce_event =
        __parallel_transform_reduce_device_kernel_submitter<_Tp, __work_group_size, _ReduceDeviceKernel>()(
            __exec, __n, __iters_per_work_item_device_kernel, __reduce_op, __transform_op, __init, __temp,
            ::std::forward<_Ranges>(__rngs)...);

    __n = __n_groups; // Number of preliminary results from the device kernel.
    const ::std::uint8_t __iters_per_work_item_work_group_kernel = __set_iters_per_work_item(__n, __work_group_size);
    return __parallel_transform_reduce_work_group_kernel_submitter<_Tp, __work_group_size, _ReduceWorkGroupKernel>()(
        ::std::forward<_ExecutionPolicy>(__exec), __reduce_event, __n, __iters_per_work_item_work_group_kernel,
                    ...
                    __cgh.parallel_for<_ReduceKernel>(
                        ...
                        [=](sycl::nd_item<1> __item_id, sycl::kernel_handler __kh) {
                            ...
                            if (__is_first)
                                ...
                                __transform_pattern2(__item_id, __n, __iters_per_work_item, __offset_2, __temp_local,
                                                     __temp_acc);
                            __dpl_sycl::__group_barrier(__item_id);
                            // 2. Reduce within work group using local memory
