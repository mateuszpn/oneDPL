    ...
    else
    {
        ...
        return __internal::__except_handler([&]() {
            return __par_backend_hetero::__parallel_find(
                ...
                __par_backend_hetero::make_iter_mode<__par_backend_hetero::access_mode::read>(__s_last),
                _Predicate{__pred}, ::std::false_type{});
        }
    }
}
                   ...
                   _Iterator2 __last2, _Pred __pred, /*vector=*/::std::true_type, /*parallel=*/::std::true_type)
{
    ...
    return __internal::__except_handler([&]() {
        ...
        auto __result = __par_backend_hetero::__parallel_find(
            ::std::forward<_ExecutionPolicy>(__exec), __first_zip, __first_zip + __n,
                  ...
                  _Predicate __pred, /*vector=*/::std::true_type, /*parallel=*/::std::true_type)
{
    ...
    return __internal::__except_handler([&]() {
        auto __res = __par_backend_hetero::__parallel_copy_if(::std::forward<_ExecutionPolicy>(__exec),
...
__pattern_shift_left(_ExecutionPolicy&& __exec, _Range __rng, oneapi::dpl::__internal::__difference_t<_Range> __n)
{
    ...
    return __internal::__except_handler([&]() {
        ...
        if (__n >= __mid)
        {
            ...
            oneapi::dpl::__par_backend_hetero::__parallel_for(::std::forward<_ExecutionPolicy>(__exec), __brick,
                                                              __size_res, __src, __dst)
                .wait();
        }
